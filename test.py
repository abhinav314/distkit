...
from distkit import Gaussian
from distkit import Binomial
...
class TestGaussianClass(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.gaussian.std, 2, 'incorrect standard deviation')
    ...
    def test_stdevcalculation(self):
        self.assertEqual(round(self.gaussian.calculate_std(), 2), 92.87, 'sample standard deviation incorrect')
        self.assertEqual(round(self.gaussian.calculate_std(0), 2), 88.55, 'population standard deviation incorrect')
    ...
    def test_pdf(self):
        ...
        self.assertEqual(round(self.gaussian.pdf(75), 5), 0.00429, \
                         'pdf function after calculating mean and std does not give expected result')
    ...
    def test_add(self):
        ...
        self.assertEqual(gaussian_sum.std, 5)
...
class TestBinomialClass(unittest.TestCase):
    ...
    def test_calculatestdev(self):
        std = self.binomial.calculate_stdev()
        self.assertEqual(round(std, 2), 2.19)
